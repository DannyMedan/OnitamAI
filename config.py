...
HEIGHT_MARGIN = 0.5 * SQ_SIZE
WIDTH_MARGIN = SQ_SIZE

CARD_HEIGHT = CARD_WIDTH = 2 * SQ_SIZE
CARD_LOCATIONS = {
    "UPPER_LEFT": (0.5 * SQ_SIZE, WIDTH_MARGIN),
    "UPPER_RIGHT": (0.5 * SQ_SIZE, TOTAL_WIDTH - CARD_WIDTH - WIDTH_MARGIN),
    "LOWER_LEFT": (TOTAL_HEIGHT-CARD_HEIGHT-0.5*SQ_SIZE, WIDTH_MARGIN),
    "LOWER_RIGHT": (TOTAL_HEIGHT-CARD_HEIGHT-0.5*SQ_SIZE, TOTAL_WIDTH - CARD_WIDTH - WIDTH_MARGIN),
    "SIDE": ((TOTAL_HEIGHT - CARD_HEIGHT)//2, BORDER_SIDES + BOARD_WIDTH + 0.25*SQ_SIZE)
}
